...
public class FirstPersonController1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        verticalLookRotation = Mathf.Clamp(verticalLookRotation, -90, 90); // 값의 범위를 지정
        transform.GetChild(1).localEulerAngles = Vector3.left * verticalLookRotation; // local : 부모의 입장에서, cameraTransform.Rotate(global) 사용하면 안됨

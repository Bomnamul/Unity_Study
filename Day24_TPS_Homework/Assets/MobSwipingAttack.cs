...
public class MobSwipingAttack : StateMachineBehaviour, IHitBoxResponder
{
    //Transform axe;
    ...
    {
        if (0.52f <= stateInfo.normalizedTime && stateInfo.normalizedTime <= 0.6f && !animator.IsInTransition(0))
        {
            hitBox.UpdateHitBox();
        }
